...
const featuredImagesTitle1 = [
  girlDresses,
  womenDresses,
  womenWatches
];
const featuredImagesTitle2 = [
  boyGlasses,
  tshirts,
  mobilePhones
];
...
// Item details List
const itemDetailsButtonList = [video,
    reviews,
    sellerpolicy,
    returnpolicy,
    supportpolicy,
